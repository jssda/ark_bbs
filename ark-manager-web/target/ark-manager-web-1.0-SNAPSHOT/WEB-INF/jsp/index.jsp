...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav topLevelMenus" pc>
                ...
                <li class="layui-nav-item" data-menu="messageManagement" pc>
                    <a href="javascript:;">
                        <i class="seraph icon-icon10" data-icon="icon-icon10"></i>
                        <cite>信息管理</cite>
                    </a>
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;">
                        <img src="${sessionScope.loginUser.userImg}" class="layui-nav-img userAvatar" width="35"
                             height="35">
                        <cite class="adminName">${sessionScope.loginUser.userName}</cite>
                    </a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${sessionScope.loginUser.userImg}" class="userAvatar"></a>
            <p>你好！<span class="userName">${sessionScope.loginUser.userName}</span>, 欢迎登录</p>
        </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2020  jssd</span></p>
    </div>
</div>
